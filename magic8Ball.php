<?php
  function magic8Ball() {
    ...
    echo "\n";
  echo "Hmm,... I can see... You question is \"$question\"...\nI understand why this weighs on you...\nI have consulted the spirit world.\nHere is your answer: ";

   $magic_number = rand(0, 19);
   echo "Your magic number is $magic_number\n";

   echo "\n";
  echo "You magic number is $magic_number.\nWhich means: "; 
